...
if ($_SERVER['REQUEST_METHOD'] === 'GET')
{
   ...
   echo "<tr><td><label>{$cfgLang['Name']}</label></td><td><input type='text' name='name' value='". ($newDevice ? "'" : htmlspecialchars($device['name']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['Device']}</label></td><td><input type='text' name='device' value='". ($newDevice ? "'" : htmlspecialchars($device['device']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['Manufacturer']}</label></td><td><input type='text' name='manufacturer' value='". ($newDevice ? "'" : htmlspecialchars($device['manufacturer']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['Model']}</label></td><td><input type='text' name='model' value='". ($newDevice ? "'" : htmlspecialchars($device['model']))."'></td></tr>";
   ...
   echo "<tr><td><label>{$cfgLang['MAC']}</label></td><td><input type='text' name='mac' value='". ($newDevice ? "'" : htmlspecialchars($device['mac']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['MAC2']}</label></td><td><input type='text' name='mac2' value='". ($newDevice ? "'" : htmlspecialchars($device['mac2']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['BT']}</label></td><td><input type='text' name='bt' value='". ($newDevice ? "'" : htmlspecialchars($device['bt']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['PhoneNumber']}</label></td><td><input type='text' name='phone_no' value='". ($newDevice ? "'" : htmlspecialchars($device['phone_no']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['IMEI1']}</label></td><td><input type='text' name='IMEI1' value='". ($newDevice ? "'" : htmlspecialchars($device['IMEI1']))."'></td></tr>";
   echo "<tr><td><label>{$cfgLang['IMEI2']}</label></td><td><input type='text' name='IMEI2' value='". ($newDevice ? "'" : htmlspecialchars($device['IMEI2']))."'></td></tr>";
...
function AddDevice()
{
   ...
   $stmt = $conn->prepare("INSERT INTO devices (
      ...
      ip_id, ip2_id, ip_isactive, mac, mac2, bt, phone_no, IMEI1, IMEI2, pn, firmware,
      custodian, location1, location2,
      status_id, purchased, disposed,
      notes)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
   ...
   $stmt->bind_param("sssssssssssssssssssssssss",
      ...
      $ip, $ip2, $ip_isactive, $mac, $mac2, $bt, $phone_no, $IMEI1, $IMEI2, $pn, $firmware,
      $custodian, $location1, $location2,
      $status, $purchased, $disposed,
      $notes);
...
function UpdateDevice()
{
   ...
   $stmt->execute([$name, $device, $manufacturer, $model, $category_id, $inventory, $sn, $ip_id, $ip2_id, $ip_isactive, $mac, $mac2, $bt, $phone_no, $IMEI1, $IMEI2, $pn, $firmware,
      $custodian, $location1, $location2, $status_id, $purchased, $disposed, $notes, $id]);
